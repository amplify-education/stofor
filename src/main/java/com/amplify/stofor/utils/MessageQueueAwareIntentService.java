 ...
 */
public abstract class MessageQueueAwareIntentService extends Service {
     ...
     */
    public MessageQueueAwareIntentService(String name) {
        super();
        mName = name;
    }
    ...
    public boolean hasIntentsScheduled() {
        return mServiceHandler.hasMessages(0);
    }
}
